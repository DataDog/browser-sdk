...
void describe('deploy', () => {
  ...
  void it('should deploy root packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      ...
      {
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum-slim/bundle/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js s3://browser-agent-artifacts-prod/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js`,
        env,
      },
      // RUM slim bundle
      {
    ...
    assert.deepEqual(getCloudfrontCommands(), [
      {
        command: `aws cloudfront create-invalidation --distribution-id EGB08BYCT1DD9 --paths /datadog-logs-v6.js,/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum.js,/chunks/recorder-${FAKE_CHUNK_HASH}-datadog-rum.js,/datadog-rum-v6.js,/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js,/datadog-rum-slim-v6.js`,
        env,
      },
    ])
  })
  ...
  void it('should deploy datacenter packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      ...
      // RUM Slim Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=14400, s-maxage=60 packages/rum-slim/bundle/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js s3://browser-agent-artifacts-prod/us1/v6/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js`,
        env,
      },
      {
        command:
    ...
    assert.deepEqual(getCloudfrontCommands(), [
      {
        command: `aws cloudfront create-invalidation --distribution-id EGB08BYCT1DD9 --paths /us1/v6/datadog-logs.js,/us1/v6/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum.js,/us1/v6/chunks/recorder-${FAKE_CHUNK_HASH}-datadog-rum.js,/us1/v6/datadog-rum.js,/us1/v6/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js,/us1/v6/datadog-rum-slim.js`,
        env,
      },
    ])
  })
  ...
  void it('should deploy staging packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      ...
      // RUM Slim Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum-slim/bundle/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js s3://browser-agent-artifacts-staging/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js`,
        env,
      },
      {
        command:
    ...
    assert.deepEqual(getCloudfrontCommands(), [
      {
        command: `aws cloudfront create-invalidation --distribution-id E2FP11ZSCFD3EU --paths /datadog-logs-staging.js,/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum.js,/chunks/recorder-${FAKE_CHUNK_HASH}-datadog-rum.js,/datadog-rum-staging.js,/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js,/datadog-rum-slim-staging.js`,
        env,
      },
    ])
  })
  ...
  void it('should deploy PR packages', async () => {
    ...
    assert.deepEqual(getS3Commands(), [
      ...
      // RUM Slim Profiler Chunk
      {
        command: `aws s3 cp --cache-control max-age=900, s-maxage=60 packages/rum-slim/bundle/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js s3://browser-agent-artifacts-staging/pull-request/123/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum-slim.js`,
        env,
      },
      {
        command:
    ...
    assert.deepEqual(getCloudfrontCommands(), [
      {
        command: `aws cloudfront create-invalidation --distribution-id E2FP11ZSCFD3EU --paths /pull-request/123/datadog-logs.js,/pull-request/123/chunks/datadogProfiler-${FAKE_CHUNK_HASH}-datadog-rum.js,/pull-request/123/chunks/recorder-${FAKE_CHUNK_HASH}-datadog-rum.js,/pull-request/123/datadog-rum.js,/pull-request/123/chunks/datadogProfiler-FAKEHASHd7628536637b074ddc3b-datadog-rum-slim.js,/pull-request/123/datadog-rum-slim.js`,
        env,
      },
    ])
  })
