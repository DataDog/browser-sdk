...
void describe('deploy', () => {
  ...
  void it('should deploy datacenter packages', async () => {
    ...
    assert.deepEqual(getCloudfrontCommands(), [
      {
        command: `aws cloudfront create-invalidation --distribution-id EGB08BYCT1DD9 --paths /us1/v6/datadog-logs.js,/us1/v6/chunks/profiler-FAKEHASHd7628536637b074ddc3b-datadog-rum.js,/us1/v6/chunks/recorder-${FAKE_CHUNK_HASH}-datadog-rum.js,/us1/v6/datadog-rum.js,/us1/v6/datadog-rum-slim.js`,
        env,
      },
    ])
  })
