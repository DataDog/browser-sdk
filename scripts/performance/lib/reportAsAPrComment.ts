...
function createMessage(
  ...
  const memoryRows = memoryBasePerformance.map((baseMemoryPerf, index) => {
    ...
    return [
      ...
      typeof baseMemoryTestValue === 'number' ? formatSize(baseMemoryTestValue) : 'N/A',
      typeof localMemoryTestValue === 'number' ? formatSize(localMemoryTestValue) : 'N/A',
      typeof baseMemoryTestValue === 'number' && typeof localMemoryTestValue === 'number'
