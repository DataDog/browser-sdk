...
export const CDN_RUM_URL = `${CDN_BASE_URL}/v6/datadog-rum.js`
export const CDN_RUM_SLIM_URL = `${CDN_BASE_URL}/v6/datadog-rum-slim.js`
export const CDN_LOGS_URL = `${CDN_BASE_URL}/v6/datadog-logs.js`
