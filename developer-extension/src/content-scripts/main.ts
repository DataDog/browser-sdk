...
export function main() {
  ...
  if (windowWithSdkGlobals.__atlasSDKBrowserSdkExtensionCallback) {
    return
  }
...
function sendEventsToExtension() {
  ...
  windowWithSdkGlobals.__atlasSDKBrowserSdkExtensionCallback = (message: unknown) => {
    // Relays any message to the "isolated" content-script via a custom event.
    window.dispatchEvent(
      new CustomEvent('__atlasSDKBrowserSdkMessage', {
        detail: message,
      })
    )
  }
