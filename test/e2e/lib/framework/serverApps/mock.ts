...
import type { RumSdkConfig } from '@datadog/browser-rum-core'
...
export function createMockServerApp(servers: Servers, setup: string, remoteConfig?: RumSdkConfig): MockServerApp {
  const app = express()
  ...
  app.get('/config', (_req, res) => {
    res.send(JSON.stringify(remoteConfig))
  })
