...
- ✨ override version [RUM] [RUM-REACT] [RUM-SLIM]
- ✨ override source [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
...
- 🐛 pr-feedback: move everything to tags [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 default value - test [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 default value deleted on conflicts [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 revert change in schema [RUM] [RUM-REACT] [RUM-SLIM]
- 🐛 linter warnings [RUM] [RUM-REACT] [RUM-SLIM]
- 🐛 pr-feedback: join test [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 tests [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 reduced the surface to browser or flutter [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 pr-feedback: simplify sdk version [RUM] [RUM-REACT] [RUM-SLIM]
- 🐛 format [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 pr-feedback: remove namespace [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 telemetry serialization [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- 🐛 telemetry of other sdks do not send the additional configuration [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
...
- 👷 update rum format [RUM] [RUM-REACT] [RUM-SLIM]
- 👷 update rum format [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
...
- ♻️ revert browser_sdk_version to be compliance with webview [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- ♻️ add types to telemetry [FLAGGING] [LOGS] [RUM] [RUM-REACT] [RUM-SLIM] [WORKER]
- ♻️ revert sandbox config
