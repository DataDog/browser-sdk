...
- [RUM-4895] Add link to playground with pr's bundle ([#2797](https://github.com/DataDog/browser-sdk/pull/2797))
- ⚗️[RUM-4780] Remote configuration ([#2799](https://github.com/DataDog/browser-sdk/pull/2799))
- Bump braces from 3.0.2 to 3.0.3 in /test/app ([#2804](https://github.com/DataDog/browser-sdk/pull/2804))
