...
const packagesWithoutSideEffect = new Set([
  ...
  'rum-events-format',
  'rum-events-format/rum',
  'rum-events-format/telemetry',
  'rum-events-format/profiling',
  'rum-events-format/session-replay',
  'rum-events-format/session-replay-browser',
  'rum-events-format/session-replay-mobile',
  'react',
  'react-router-dom',
  'vue',
  'vue-router',
