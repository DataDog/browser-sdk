...
[2]: https://nextjs.org/docs/app/api-reference/file-conventions/error
...
Use `NextjsErrorBoundary` to catch client-side errors in any part of your page tree and report them to Datadog RUM:
...
You can also call `addNextjsError` directly for errors you catch manually:
