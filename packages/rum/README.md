...
After the Datadog Browser SDK for RUM is initialized, you can access the internal context of the SDK. This allows you to access the following attributes:
