...
import type { createRumProfiler } from '../domain/profiling/datadog-profiler'
...
export async function importProfiler() {
  const module = await import(/* webpackChunkName: "datadog-profiler" */ '../domain/profiling/datadog-profiler')
