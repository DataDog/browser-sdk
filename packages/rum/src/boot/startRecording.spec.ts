...
describe('startRecording', () => {
  ...
  it('does not split Meta, Focus and Change records between multiple segments when taking a full snapshot', async () => {
    ...
    expect(requests[0].segment.records[2].type).toBe(RecordType.Change)
  })
