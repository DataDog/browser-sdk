import { DOM_EVENT, throttle, addEventListener } from '@flashcatcloud/browser-core'
import type { RumConfiguration } from '@flashcatcloud/browser-rum-core'
import { getScrollX, getScrollY, getNodePrivacyLevel, NodePrivacyLevel } from '@flashcatcloud/browser-rum-core'
