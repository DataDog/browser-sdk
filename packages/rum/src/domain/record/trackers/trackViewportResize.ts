import { throttle, DOM_EVENT, addEventListeners, timeStampNow, noop } from '@flashcatcloud/browser-core'
import type { RumConfiguration, ViewportDimension } from '@flashcatcloud/browser-rum-core'
import { initViewportObservable } from '@flashcatcloud/browser-rum-core'
