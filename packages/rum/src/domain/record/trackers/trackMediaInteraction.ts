...
import type { MediaInteractionData, BrowserIncrementalSnapshotRecord } from 'rum-events-format/session-replay-browser'
import { IncrementalSource, MediaInteractionType } from 'rum-events-format/session-replay-browser'
