import { instrumentSetter, DOM_EVENT, addEventListeners, noop } from '@flashcatcloud/browser-core'
import { NodePrivacyLevel, getNodePrivacyLevel, shouldMaskNode } from '@flashcatcloud/browser-rum-core'
