...
import { MutationKind, getElementInputValue, serializeNodeWithId, serializeAttribute } from '../serialization'
 ...
 */
export function trackMutation(scope: SerializationScope, target: Node): MutationTracker {
...
function processMutations(mutations: RumMutationRecord[], transaction: MutationTransaction) {
