import { globalObject, mockable, setInterval, clearInterval } from '@datadog/js-core/util'
import type { TimeoutId } from '@datadog/js-core/util'
import { dateNow } from '@datadog/js-core/time'
import { addTelemetryDebug, fetch, isServerError } from '@datadog/browser-core'
