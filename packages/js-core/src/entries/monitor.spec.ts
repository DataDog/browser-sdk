...
describe('monitor', () => {
  ...
  describe('decorator', () => {
    ...
    it('should report error', () => {
      ...
      expect(onMonitorErrorCollectedSpy).toHaveBeenCalledExactlyOnceWith(new Error('monitored'))
    })

    it('should report string error', () => {
      candidate.monitoredStringErrorThrowing()

      expect(onMonitorErrorCollectedSpy).toHaveBeenCalledExactlyOnceWith('string error')
    })

    it('should report object error', () => {
      candidate.monitoredObjectErrorThrowing()

      expect(onMonitorErrorCollectedSpy).toHaveBeenCalledExactlyOnceWith({ foo: 'bar' })
    })
  })
  ...
  describe('function', () => {
    ...
    describe('callMonitored', () => {
      ...
      it('should report error', () => {
        ...
        expect(onMonitorErrorCollectedSpy).toHaveBeenCalledExactlyOnceWith(new Error('error'))
      })
    })
