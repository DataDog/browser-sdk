import { ErrorHandling, ErrorSource, noop } from '@flashcatcloud/browser-core'
import type { MockReportingObserver } from '@flashcatcloud/browser-core/test'
import { mockReportingObserver } from '@flashcatcloud/browser-core/test'
