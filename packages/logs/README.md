...
| `telemetrySampleRate` | Number                                                                    | No       | `20`            | Telemetry data (error, debug logs) about SDK execution is sent to Datadog in order to proactively detect and solve potential issue. Set this option to `0` to opt out from telemetry collection. |
