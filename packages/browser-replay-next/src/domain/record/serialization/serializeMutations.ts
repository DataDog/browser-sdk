...
import type { RumMutationRecord, RumChildListMutationRecord, RumCharacterDataMutationRecord, RumAttributesMutationRecord } from '../record.types'
...
import type { TimeStamp } from './serializationTransaction'
