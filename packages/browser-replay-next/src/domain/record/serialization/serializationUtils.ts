import { CENSORED_STRING_MARK, shouldMaskNode } from '../../privacy'
import type { NodePrivacyLevel } from '../../privacy'

// Inlined from @datadog/browser-core buildUrl
function buildUrl(url: string, base?: string): URL {
