...
import { RumSessionManager, startRumSessionManagement, startRumSessionStub } from '../domain/rumSessionManager'
...
export function startRum(
  ...
  const session = !canUseEventBridge() ? startRumSessionManagement(configuration, lifeCycle) : startRumSessionStub()
