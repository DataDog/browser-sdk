...
describe('rum public api', () => {
  ...
  describe('startOperationStepVital', () => {
    it('should call addOperationStepVital on the startRum result with start status', () => {
      ...
      rumPublicApi.init(DEFAULT_INIT_CONFIGURATION)
      rumPublicApi.startOperationStepVital('foo', '00000000-0000-0000-0000-000000000000')
  ...
  describe('succeedOperationStepVital', () => {
    it('should call addOperationStepVital on the startRum result with end status', () => {
      ...
      rumPublicApi.init(DEFAULT_INIT_CONFIGURATION)
      rumPublicApi.succeedOperationStepVital('foo', '00000000-0000-0000-0000-000000000000')
      expect(addOperationStepVitalSpy).toHaveBeenCalledWith(
        'foo',
        'end',
        '00000000-0000-0000-0000-000000000000',
  ...
  describe('failOperationStepVital', () => {
    it('should call addOperationStepVital on the startRum result with end status and failure reason', () => {
      ...
      rumPublicApi.init(DEFAULT_INIT_CONFIGURATION)
      rumPublicApi.failOperationStepVital('foo', '00000000-0000-0000-0000-000000000000', 'page not found')
      expect(addOperationStepVitalSpy).toHaveBeenCalledWith(
        'foo',
        'end',
        '00000000-0000-0000-0000-000000000000',
