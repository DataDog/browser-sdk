...
import { deleteDatadogEventBridgeStub, initDatadogEventBridgeStub } from '../../../core/test/specHelper'
...
describe('rum public api', () => {
  describe('configuration validation', () => {
    ...
    describe('if event bridge detected', () => {
      ...
      it('init should force sample rate to 100 if an event bridge is detected', () => {
