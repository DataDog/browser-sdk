import type { Context, EndpointBuilder, TelemetryEvent, Observable, RawError, PageState } from '@datadog/browser-core'
...
export function startRumBatch(
  ...
  const batch = makeRumBatch(configuration, reportError, pageState)
