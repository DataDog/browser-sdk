...
import type { RumEventType, RumEventTypeEnum } from './rawRumEvent.types'

export type RumEventDomainContext<T extends RumEventTypeEnum = any> = T extends typeof RumEventType.VIEW
