...
import { createTaskQueue, RequestType, ResourceType } from '@datadog/browser-core'
import { replaceMockableWithSpy, registerCleanupTask } from '@datadog/browser-core/test'
...
describe('resourceCollection', () => {
  ...
  function setupResourceCollection(partialConfig: Partial<RumConfiguration> = { trackResources: true }) {
    replaceMockableWithSpy(retrieveInitialDocumentResourceTiming)
