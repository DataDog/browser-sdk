import type { RelativeTime, Subscription, TimeStamp } from '@flashcatcloud/browser-core'
import { DOM_EVENT, Observable } from '@flashcatcloud/browser-core'
import type { Clock } from '@flashcatcloud/browser-core/test'
import { createNewEvent, mockClock, registerCleanupTask } from '@flashcatcloud/browser-core/test'
