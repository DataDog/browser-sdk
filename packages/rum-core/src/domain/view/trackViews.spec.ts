...
describe('view lifecycle', () => {
  ...
  it('should notify BEFORE_VIEW_ENDED before VIEW_ENDED', () => {
    ...
    viewTest.stop()
    expect(notifySpy.calls.argsFor(0)[0]).toEqual(LifeCycleEventType.BEFORE_VIEW_ENDED)
    expect(notifySpy.calls.argsFor(1)[0]).toEqual(LifeCycleEventType.VIEW_ENDED)
  })
})
