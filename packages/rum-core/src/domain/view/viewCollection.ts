...
function processViewUpdate(
  ...
  const viewEvent: RawRumViewEvent = {
    ...
    view: {
      ...
      first_input_delay: toServerDuration(view.initialViewMetrics.firstInputTimings?.firstInputDelay),
      first_input_time: toServerDuration(view.initialViewMetrics.firstInputTimings?.firstInputTime),
      first_input_target_selector: view.initialViewMetrics.firstInputTimings?.firstInputTargetSelector,
