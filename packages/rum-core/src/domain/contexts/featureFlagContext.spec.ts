import type { CustomerDataTracker, RelativeTime } from '@flashcatcloud/browser-core'
import { relativeToClocks, createCustomerDataTracker, noop } from '@flashcatcloud/browser-core'
