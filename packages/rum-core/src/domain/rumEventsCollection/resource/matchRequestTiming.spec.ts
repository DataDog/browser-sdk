import { Duration, isIE, RelativeTime, clocksWith } from '@datadog/browser-core'
...
describe('matchRequestTiming', () => {
  const FAKE_REQUEST: Partial<RequestCompleteEvent> = { startClocks: clocksWith(100), duration: 500 as Duration }
