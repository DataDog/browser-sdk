...
type SerializedOption =
  | { rcSerializedType: 'string'; value: string }
  | { rcSerializedType: 'regex'; value: string }
  | DynamicOption
...
function resolveCookieValue({
  ...
  name: string
  extractor?: { rcSerializedType: 'regex'; value: string }
}) {
...
function extractValue(extractor: { rcSerializedType: 'regex'; value: string }, candidate: string) {
