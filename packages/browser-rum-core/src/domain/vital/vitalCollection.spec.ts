...
describe('vitalCollection', () => {
  ...
  beforeEach(() => {
    clock = mockClock()
    wasInPageStateDuringPeriodSpy = vi
      .spyOn(pageStateHistory, 'wasInPageStateDuringPeriod')
  ...
  describe('custom duration', () => {
    ...
    it('should notify lifecycle with vital started event when starting a duration vital', () => {
      ...
      expect(subscriberSpy).toHaveBeenCalledExactlyOnceWith(expect.objectContaining({ name: 'foo' }))
    })
  })
