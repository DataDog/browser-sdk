...
// output, or Emscripten without `-gseparate-dwarf`). A SHA-256-of-code-section
// fallback is the canonical solution but requires SDK ↔ uploader algorithm
// agreement — left as a follow-up (see gap analysis "open questions").
