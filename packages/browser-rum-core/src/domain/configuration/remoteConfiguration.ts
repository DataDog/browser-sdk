...
import { display, mapValues, getCookie, addTelemetryMetrics, TelemetryMetrics } from '@datadog/browser-core'
import { fetch, isIndexableObject } from '@datadog/js-core/util'
