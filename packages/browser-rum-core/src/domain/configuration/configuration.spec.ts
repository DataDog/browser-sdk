...
describe('validateAndBuildRumConfiguration', () => {
  ...
  beforeEach(() => {
    displayErrorSpy = vi.spyOn(display, 'error').mockImplementation(() => undefined)
    displayWarnSpy = vi.spyOn(display, 'warn').mockImplementation(() => undefined)
  })
  ...
  describe('traceSampleRate', () => {
    ...
    it('does not validate the configuration if an incorrect value is provided', () => {
      ...
      expect(displayErrorSpy).toHaveBeenCalledTimes(1)
      expect(displayErrorSpy).toHaveBeenCalledExactlyOnceWith('Trace Sample Rate should be a number between 0 and 100')
  ...
  describe('allowedTracingUrls', () => {
    ...
    it('does not validate the configuration if an incorrect value is provided', () => {
      ...
      expect(displayErrorSpy).toHaveBeenCalledTimes(1)
      expect(displayErrorSpy).toHaveBeenCalledExactlyOnceWith('Allowed Tracing URLs should be an array')
    })
  })
  ...
  describe('excludedActivityUrls', () => {
    ...
    it('does not validate the configuration if an incorrect value is provided', () => {
      ...
      expect(displayErrorSpy).toHaveBeenCalledTimes(1)
      expect(displayErrorSpy).toHaveBeenCalledExactlyOnceWith('Excluded Activity Urls should be an array')
    })
  })
  ...
  describe('trackFeatureFlagsForEvents', () => {
    ...
    it('does not validate the configuration if an incorrect value is provided', () => {
      ...
      expect(displayWarnSpy).toHaveBeenCalledTimes(1)
      expect(displayWarnSpy).toHaveBeenCalledExactlyOnceWith('trackFeatureFlagsForEvents should be an array')
    })
  })
  ...
  describe('allowedGraphQlUrls', () => {
    ...
    it('should reject invalid values', () => {
      ...
      expect(displayWarnSpy).toHaveBeenCalledTimes(1)
      expect(displayWarnSpy).toHaveBeenCalledExactlyOnceWith('allowedGraphQlUrls should be an array')
    })
  })
})
