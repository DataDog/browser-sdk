...
export async function startRumSessionManager(configuration: RumConfiguration): Promise<RumSessionManager> {
  const sessionManager = await startSessionManager(configuration.cookieOptions, RUM_SESSION_KEY, (rawTrackingType) =>
