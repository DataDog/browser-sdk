import { ContextAttributes, Environment, FlagKey, FormatEnum, PrecomputedFlag } from '../interfaces'
...
export class PrecomputedConfiguration implements IPrecomputedConfiguration {
  ...
  public static unobfuscated(
    ...
    const response = new PrecomputedConfigurationResponse(subjectKey, flags, subjectAttributes, environment)
...
export class ConfigurationWireV1 implements IConfigurationWire {
  ...
  private constructor(readonly precomputed?: IPrecomputedConfiguration) {}

  public toString(): string {
    return JSON.stringify(this as IConfigurationWire)
  }

  public static fromString(str: string): IConfigurationWire {
