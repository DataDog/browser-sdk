import type { LifeCycle, RumConfiguration, StartRecordingOptions, ViewHistory } from '@openobserve/browser-rum-core'
import { LifeCycleEventType, SessionReplayState, computeSessionReplayState } from '@openobserve/browser-rum-core'
import type { Telemetry, DeflateEncoder, SessionManager } from '@openobserve/browser-core'
