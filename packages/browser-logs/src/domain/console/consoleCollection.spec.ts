import type { BufferedData, ConsoleLog, RawError } from '@openobserve/browser-core'
import { clocksNow } from '@openobserve/js-core/time'
import { ConsoleApiName } from '@openobserve/js-core/util'
import { BufferedDataType, ErrorHandling, ErrorSource, Observable, noop, objectEntries } from '@openobserve/browser-core'
