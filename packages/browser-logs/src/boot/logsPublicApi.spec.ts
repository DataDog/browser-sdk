  ...
  describe('post start API usages', () => {
    ...
    describe('user', () => {
      it('should call setContext', () => {
        vi.spyOn(userContext, 'setContext').mockImplementation(() => undefined)
        logsPublicApi.setUser(2 as any)
        expect(userContext.setContext).toHaveBeenCalledTimes(1)
      })

      it('should call setContextProperty', () => {
        vi.spyOn(userContext, 'setContextProperty').mockImplementation(() => undefined)
      ...
      it('should call removeContextProperty', () => {
        vi.spyOn(userContext, 'removeContextProperty').mockImplementation(() => undefined)
      ...
      it('should call clearContext', () => {
        vi.spyOn(userContext, 'clearContext').mockImplementation(() => undefined)
