...
import { SESSION_COOKIE_NAME, SESSION_EXPIRATION_DELAY, persistSession } from './sessionManagement'
...
describe('old cookies migration', () => {
  ...
  it('should not touch current cookie', () => {
    ...
    tryOldCookiesMigration(cacheCookieAccess(SESSION_COOKIE_NAME, options), persistSession)
