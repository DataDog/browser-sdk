...
describe('contextHistory', () => {
  ...
  describe('find', () => {
    it('should return undefined when there is no ongoing entry and no startTime', () => {
      expect(contextHistory.find()).toBeUndefined()
    })

    it('should return the context of the first  entry when there is no startTime', () => {
  ...
  describe('findAll', () => {
    it('should return an empty array when there is no ongoing entry and no startTime', () => {
      expect(contextHistory.findAll()).toEqual([])
    })

    it('should return all ongoing entry context when there is no startTime', () => {
      contextHistory.add('foo', 0 as RelativeTime)
      contextHistory.add('bar', 5 as RelativeTime).close(10 as RelativeTime)
      contextHistory.add('qux', 10 as RelativeTime)
