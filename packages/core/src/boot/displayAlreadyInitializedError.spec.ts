...
describe('displayAlreadyInitializedError', () => {
  it('should display an error', () => {
    ...
    displayAlreadyInitializedError('MV_SDK_DD_RUM', {} as InitConfiguration)
  ...
  it('should not display an error if the "silentMultipleInit" option is used', () => {
    const displayErrorSpy = spyOn(display, 'error')
    displayAlreadyInitializedError('MV_SDK_DD_RUM', { silentMultipleInit: true } as InitConfiguration)
