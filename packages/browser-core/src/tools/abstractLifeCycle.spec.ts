...
describe('AbstractLifeCycle', () => {
  ...
  it('notifies subscribers', () => {
    ...
    expect(subscriber1Spy).toHaveBeenCalledExactlyOnceWith('bar')
    expect(subscriber2Spy).toHaveBeenCalledTimes(1)
    expect(subscriber2Spy).toHaveBeenCalledExactlyOnceWith('bar')
  })
  ...
  it('notifies subscribers for events without data', () => {
    ...
    expect(subscriberSpy).toHaveBeenCalledExactlyOnceWith(undefined)
  })
