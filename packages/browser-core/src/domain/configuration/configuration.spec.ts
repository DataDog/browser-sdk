...
describe('validateAndBuildConfiguration', () => {
  ...
  describe('validate init configuration', () => {
    it('requires the InitConfiguration to be defined', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Client Token is not configured, we will not send any data.')
    })
    ...
    it('requires sessionSampleRate to be a percentage', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Session Sample Rate should be a number between 0 and 100')
    ...
    it('requires telemetrySampleRate to be a percentage', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Telemetry Sample Rate should be a number between 0 and 100')
  ...
  describe('trackingConsent', () => {
    ...
    it('rejects invalid values', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Tracking Consent should be either "granted" or "not-granted"')
    })
  })
  ...
  describe('env parameter validation', () => {
    it('should validate the env parameter', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Env must be defined as a string')
    })
  })
  ...
  describe('service parameter validation', () => {
    it('should validate the service parameter', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Service must be defined as a string')
    })
  ...
  describe('version parameter validation', () => {
    it('should validate the version parameter', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Version must be defined as a string')
    })
  })
  ...
  describe('allowedTrackingOrigins parameter validation', () => {
    it('should validate the allowedTrackingOrigins parameter', () => {
      ...
      expect(displaySpy).toHaveBeenCalledExactlyOnceWith('Allowed Tracking Origins must be an array')
    })
  })
