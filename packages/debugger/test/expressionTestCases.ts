/**
 * Test case definitions for the expression compiler.
...
export type TestCaseTuple = [ExpressionNode, VariableBindings, unknown]
...
class EvilRegex extends RegExp {
  exec(_string: string): RegExpExecArray | null {
    throw new Error('This should never throw!')
  }
}

export const literals: TestCase[] = [
  [null, {}, null],
  [42, {}, 42],
  [true, {}, true],
  ['foo', {}, 'foo'],
...
export const references: TestCase[] = [
  [{ ref: 'foo' }, { foo: 42 }, 42],
...
export const propertyAccess: TestCase[] = [
  ...
  [{ getmember: [{ getmember: [{ ref: 'obj' }, 'foo'] }, 'bar'] }, { obj: { foo: { bar: 'test-me' } } }, 'test-me'],
  [
...
export const sizes: TestCase[] = [
  ...
  [{ len: { ref: 'wset' } }, { wset: new WeakSet([weakKey]) }, new TypeError('Cannot get size of WeakSet or WeakMap')],
  [
    { len: { ref: 'wmap' } },
  ...
  [{ isEmpty: { ref: 'obj' } }, { obj: new WeakSet() }, new TypeError('Cannot get size of WeakSet or WeakMap')],
]

export const equality: TestCase[] = [
...
export const stringManipulation: TestCase[] = [
...
export const stringComparison: TestCase[] = [
...
/* eslint-disable id-denylist -- `any` and `all` are expression language operator names, not JS identifiers */
export const logicalOperators: TestCase[] = [
...
export const collectionOperations: TestCase[] = [
...
export const membershipAndMatching: TestCase[] = [
  ...
  [{ contains: [{ ref: 'obj' }, 'foo'] }, { obj: { foo: 'bar' } }, new TypeError('Variable does not support contains')],
  [
...
export const typeAndDefinitionChecks: TestCase[] = [
  // Primitive types
  [{ instanceof: [{ ref: 'foo' }, 'string'] }, { foo: 'foo' }, true],
  [{ instanceof: [{ ref: 'foo' }, 'number'] }, { foo: 42 }, true],
  [{ instanceof: [{ ref: 'foo' }, 'number'] }, { foo: '42' }, false],
  {
    ast: { instanceof: [{ ref: 'foo' }, 'bigint'] },
    vars: { foo: typeof BigInt !== 'undefined' ? BigInt(42) : undefined },
 ...
 */
function overloadPropertyWithGetter<T extends object>(obj: T, propName: string): T {
 ...
 */
function overloadMethod<T extends object>(obj: T, methodName: PropertyKey): T {
 ...
 */
function createClassWithOverloadedMethodInPrototypeChain<T extends new (...args: any[]) => any>(
  Builtin: T,
